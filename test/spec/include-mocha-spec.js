...
/** @function includeMocha.includeScript()
 *
 * @description Insert a script node into the head node.
 *
 * @param {string} src
 * @param {boolean} async
 *
 * @returns {HTMLScriptElement|Error} - Object of the class Error or the inseted node.
 *
*/
...
/* include-mocha.js */
  ...
  /* include-mocha.js loaded */
    //
    /* includeMocha */
      //-- Should contain an object of the class "includeMocha".
    //
    /* includeMocha.option */
      //-- Should contain null.
    //
    ...
    /* includeMocha.includeScript( src, async ) */
      //
      //-- Should contain an object of the class "Function"
      //
      //-- Should return an object of class "Error" if the param "src" is not string or undefined.
    ...
    /* includeMocha.includeStylesheet( href ) */
      ...
      //
      //-- Shoule insert a node "link" into the node "head" as last child.
